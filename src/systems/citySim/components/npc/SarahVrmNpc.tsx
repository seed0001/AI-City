...
const MODEL_URL = "/models/npc/Riko1.vrm";
...
/**
 * Sarah (VRM) using Riko1 model.
 */
export default function SarahVrmNpc({ entityId }: Props) {
  ...
  useEffect(() => {
    ...
    void loader
      ...
      .then((gltfAnim) => {
        ...
        if (!vrmAnimation) {
          console.warn("[SarahVrmNpc] No vrmAnimations in", STANDING_VRMA_URL);
          return;
        }
      ...
      .catch((err) => {
        console.warn("[SarahVrmNpc] Standing VRMA failed:", err);
      });
